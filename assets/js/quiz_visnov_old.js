...
quizVisnov.prototype.setCurrItem = function(curr_item, max_item){
    var $this = this;
    // alert(max_item);
...
quizVisnov.prototype.next = function($clone,$type) {
    var $this = this;
    game.setSlide(3);
};
...
quizVisnov.prototype.setQuizFalseAnswer = function(){
    var last_life = parseInt($this.life);
    $this.setFalseAnswer();
    var arr_temp = [];
...
quizVisnov.prototype.showModalFeedback = function(benar, timeout = 0){
    var $this = this;
...
quizVisnov.prototype.setFalseAnswer = function(){
    var $this = this;
            ...
            if(ldata["answer"].length == total["total_soal"]){
                ...
                $(".btn-next-result").click(function(e){
                    ...
                    if($this.category_game == $this.ldatas['list_question'].length - 1){
                        ...
                        $this.resetGameData();
                        $this.game_data['category_game'] = $this.category_game + 1;
                        console.log($this.game_data);
...
quizVisnov.prototype.hideItemSelected = function(item_id){
    var $this = this;
    var item_div_n = $this.category_game + 1;
    $('#item_div-'+item_div_n+' #item-'+item_id).hide();
}

quizVisnov.prototype.nextGamePickPlaceItem = function(){
    var $this = this;
    console.log(video1);
    // $this.stopVideo_plyr(video1);
}

quizVisnov.prototype.setScore = function(score){
    var $this = this;
    // var total = game.scorm_helper.getQuizResult(["game_slide_"+$this.current_settings["slide"]]);
    // console.log(total);
    $this.game_data['last_score'] = score;
    $this.game_data['last_score'] = $this.game_data['last_score'];
}
...
quizVisnov.prototype.resetGameData = function(){
    $this.game_data["category_game"]=undefined,
    $this.game_data["last_challenge"]=undefined,
    $this.game_data["last_life"]=undefined,
    $this.game_data["last_score"]=undefined;
    $this.game_data["start_date"]=undefined;
}
...
quizVisnov.prototype.nextSoalAtLast = function(){
    ...
    /*Function set stage clear*/ 
        ...
        let percent_correct_answer =  $this.game_data["total_answer_true"] / $this.game_data["total_soal_current_slide"] * 100;
