...
var ScormHelper = function(){
	...
	try{
		...
		if(this.lmsConnected){
			...
			// last duration
			var prevduration = this.scorm.get("cmi.core.session_time");
		...
		// 	"curr_slide":12,
		// 	"quiz":[
		// 		{"index":"game_slide_12","answer":[0,0,0,0,0,0],"list_question":[0, 1, 2, 3, 4, 5],"start_date":"12 Februari 2020 22:28:4","end_date":"12 Februari 2020 22:28:59","is_complete":true}
		// 	],
		// 	"game_data":{
		// 		"total_stage": 2,
		// 		"curr_step":1,
