...
quizVisnov.prototype.mulai_game = function(){
    ...
    if(ldata == undefined || ldata["answer"] == undefined || ldata["answer"]== null){
        ...
        ldata = sdata;
        // $this.curr_soal = 0;
         $this.feedback_type = $this.question_datas[$this.curr_soal]["feedback_type"];
        // console.log($this.question_data);
...
quizVisnov.prototype.cekJawaban = function($clone,$type) {
    ...
    if($flag==0){
        ...
        // else if($this.feedback_type == 'video'){
        //     if($this.question_datas[$this.curr_soal]["feedback_popup"] != undefined){
        ...
        if($this.isTimer){
            ...
            timer_interval = setInterval(function() {
                ...
                if($this.countTime>0){
                    ...
                    //set game_data and send to scorm
                    var ldata = game.scorm_helper.getLastGame("game_slide_"+$this.current_settings["slide"]+"_"+$this.curr_soal);
                    // console.log(ldata);
...
quizVisnov.prototype.nextSoalAtLast = function(){
    ...
    if($this.setting_global['linear_visual_novel'] != undefined){
        ...
        if($this.setting_global['hide_result_step_page'] != undefined){
            ...
            // game.setSlide($this.setting_global["slide_stage_brankas"]);
            game.nextSlide();
        }
    }
}
