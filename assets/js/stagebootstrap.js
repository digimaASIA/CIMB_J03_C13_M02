	...
	for(var i = 0; i < $this.items.length; i++){
		...
		if($($clone).hasClass("complete")){
			...
			$($clone).click(function(e){
				...
				console.log($this.game_data);
				// if($this.game_data["slide"] != undefined){
					let arr_slide_quiz_n = $this.setting_global["arr_slide_quiz_n"];
					let a = arr_slide_quiz_n[parseInt(index)-1];
					// a = 11;
					// $this.game_data["selected_stage"] = 2;
					console.log(a);
					game.setSlide(a);
				// }else{
				//   game.nextSlide();
